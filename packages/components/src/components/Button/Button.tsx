...
const themeStyles = EDSStyleSheet.create(
  (theme, props: ButtonStyleSheetProps) => {
    ...
    return {
      ...
      pressableContainer: {
        minHeight:
          theme.geometry.dimension.button.minHeight - outlinedHeightReduction,
        paddingHorizontal:
          theme.spacing.button.paddingHorizontal - outlinedPaddingReduction,
        paddingVertical:
          theme.spacing.button.paddingVertical - outlinedPaddingReduction,
