    ...
    <ScrollView style={styles.container}>
      <View style={styles.section}>
        ...
        <Typography variant="p">
          Select lets users pick from a predefined list of options. It&apos;s
          ideal when the choices are fixed and don&apos;t need filtering.
        </Typography>
      </View>
      ...
      <View style={styles.section}>
        <Typography variant="h6">Select with Custom Placeholder</Typography>
        <Spacer amount="small" />
