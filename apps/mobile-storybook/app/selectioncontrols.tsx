...
export default function SelectionControlsScreen() {
  ...
  const [secondSmallSwitchActive, setSecondSmallSwitchActive] = useState(true);
    ...
    <ScrollView style={{ flex: 1 }}>
      <View style={{ padding: 16 }}>
        ...
        <Typography variant="p">
          Radio buttons and switches let users make choices — pick one option
          from a group, or toggle a setting on and off.
        </Typography>
        <Spacer amount="large" />
        ...
        <Spacer amount="small" />
        <Typography variant="p">Primary and Secondary colors</Typography>
        <Spacer amount="small" />
        ...
        >
          <View>
            <Typography variant="p">
              Switch is now {secondSmallSwitchActive ? "ON" : "OFF"}
            </Typography>
          </View>
        </Popover>
      </View>
