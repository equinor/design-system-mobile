    ...
    <ScrollView style={styles.container}>
      <View style={styles.section}>
        ...
        <Typography variant="p">
          Paper provides a surface for content with configurable elevation.
          It&apos;s great for grouping related information and creating visual
          hierarchy.
        </Typography>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Paper elevation="raised" style={styles.paper}>
          <Typography variant="p">
            This is a Paper component. It provides elevation and a card-like
            appearance.
          </Typography>
        </Paper>
      ...
      <View style={styles.section}>
        ...
        <Paper elevation="raised" style={styles.paper}>
          ...
          <Typography style={styles.cardText}>
            Paper components are great for grouping related content together.
            They provide visual hierarchy and help organize information.
          </Typography>
        </Paper>
