    ...
    <ScrollView style={styles.container}>
      <View style={styles.section}>
        ...
        <Typography variant="p">
          Autocomplete helps users find and select from a list of options as
          they type. Ideal for long lists like countries, tags, or categories.
        </Typography>
      </View>
      ...
      <View style={styles.section}>
        ...
        {selectedCountry && (
          <Typography variant="p">Selected: {selectedCountry.label}</Typography>
        )}
