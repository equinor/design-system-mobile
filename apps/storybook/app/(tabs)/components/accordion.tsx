...
import { Accordion, Radio, Typography } from "@equinor/eds-mobile";
    ...
    <ScrollView style={styles.container}>
      <View style={styles.section}>
        ...
        <Typography variant="p">
          Accordions tuck content away until it&apos;s needed — perfect for
          keeping screens tidy while still giving users access to all the
          details.
        </Typography>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Typography variant="p">
          Tap to expand, tap again to collapse. Simple! Works well for FAQs,
          settings, or any content you want to group together.
        </Typography>
        <Accordion>
          ...
          <Accordion.Item title="Second Item">
            ...
            <View style={styles.list}>
              <Typography variant="p">• First list item</Typography>
              <Typography variant="p">• Second list item</Typography>
              <Typography variant="p">• Third list item</Typography>
              <Typography variant="p">• Fourth list item</Typography>
            </View>
          </Accordion.Item>

          <Accordion.Item title="Third Item">
            <Typography variant="p">
              You can also have a group of radio buttons within the accordion
            </Typography>
      ...
      <View style={styles.section}>
        <Typography variant="h6">Accordion with Default Open</Typography>
        <Typography variant="p">
          Sometimes you want content visible right away — just set it to open by
          default and users see it straight off.
        </Typography>
      ...
      <View style={styles.section}>
        ...
        <Typography variant="p">
          You can move the chevron to the right for a different layout. If some
          content isn&apos;t ready yet, disable the item to let users know.
        </Typography>
        <Accordion>
