    ...
    <ScrollView style={styles.container}>
      <View style={styles.section}>
        ...
        <Typography variant="p">
          Environment banners indicate which environment the app is running in.
          They help prevent accidental changes in production by making the
          current environment clearly visible.
        </Typography>
      </View>
